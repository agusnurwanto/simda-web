...
$(document).ready(function()
{
	...
	$('body').on('submit', '.--xhr-form', function(e)
	{
		...
		{
			old_date[$(this).attr('name')]			= $(this).val();
			
			var date								= new Date($(this).val());
			
			$(this).val(date.toLocaleString('id', {year: 'numeric'}) + '-' + date.toLocaleString('id', {month: 'numeric'}) + '-' + date.toLocaleString('id', {day: 'numeric'}))
		});
		...
		.done(function(response)
		{
			...
			if(old_date)
			{
				$.each(old_date, function(key, val)
				{
