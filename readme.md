...
- Untuk koneksi dengan PDO ODBC di server linux yang menggunakan freetds, perlu mengisi kolom DSN dengan nilai **odbc:nama_dsn_odbc;DRIVER=freetds;DATABASE=nama_db_simda**
