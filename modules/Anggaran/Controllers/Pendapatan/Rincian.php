...
{
	private $_table									= 'ta_pendapatan_rinc';
	...
	private function _header()
	{
		...
		('
			ta_pendapatan.kd_urusan,
			ta_pendapatan.kd_bidang,
			ta_pendapatan.kd_unit,
			ta_pendapatan.kd_sub,
			ta_pendapatan.kd_keg,
			ta_pendapatan.kd_rek_1,
			ta_pendapatan.kd_rek_2,
			ta_pendapatan.kd_rek_3,
			ta_pendapatan.kd_rek_4,
			ta_pendapatan.kd_rek_5,
			ref_rek_5.nm_rek_5,
		...
		(
			'ref_rek_5',
			'ref_rek_5.kd_rek_1 = ta_pendapatan.kd_rek_1 AND ref_rek_5.kd_rek_2 = ta_pendapatan.kd_rek_2 AND ref_rek_5.kd_rek_3 = ta_pendapatan.kd_rek_3 AND ref_rek_5.kd_rek_4 = ta_pendapatan.kd_rek_4 AND ref_rek_5.kd_rek_5 = ta_pendapatan.kd_rek_5'
		)
		->join
		(
			'ref_sub_unit',
			'ref_sub_unit.kd_urusan = ta_pendapatan.kd_urusan AND ref_sub_unit.kd_bidang = ta_pendapatan.kd_bidang AND ref_sub_unit.kd_unit = ta_pendapatan.kd_unit AND ref_sub_unit.kd_sub = ta_pendapatan.kd_sub'
		)
		->get_where
		(
			'ta_pendapatan',
			array
			(
				'ta_pendapatan.kd_urusan'			=> service('request')->getGet('kd_urusan'),
				'ta_pendapatan.kd_bidang'			=> service('request')->getGet('kd_bidang'),
				'ta_pendapatan.kd_unit'				=> service('request')->getGet('kd_unit'),
				'ta_pendapatan.kd_sub'				=> service('request')->getGet('kd_sub'),
				'ta_pendapatan.kd_prog'				=> '0',
				'ta_pendapatan.id_prog'				=> '0',
				'ta_pendapatan.kd_keg'				=> '0',
				'ta_pendapatan.kd_rek_1'			=> service('request')->getGet('kd_rek_1'),
				'ta_pendapatan.kd_rek_2'			=> service('request')->getGet('kd_rek_2'),
				'ta_pendapatan.kd_rek_3'			=> service('request')->getGet('kd_rek_3'),
				'ta_pendapatan.kd_rek_4'			=> service('request')->getGet('kd_rek_4'),
				'ta_pendapatan.kd_rek_5'			=> service('request')->getGet('kd_rek_5')
			),
			1
		)
		->row();
