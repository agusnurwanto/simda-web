<?php namespace Modules\Bendahara\Controllers\Sts;
use Config\Validation;

/**
 * Bendahara > Bukti Penerimaan STS
 *
 * @since			version 1.0.0
 * @author			GeekTech Karya Indonesia, Ltd.
 * @website			www.geektech.id
 */
class Sts extends \Aksara\Laboratory\Core
{
	private $_table									= 'ta_sts';
	...
	public function index()
	{
		...
		(
			array
			(
				'bendahara/sts/sub_unit' => 'Bendahara Penerimaan Sts'
			)
		);
		$this->set_title('Bukti Penerimaan')
		->set_icon('mdi mdi-pinweheel-outline')
