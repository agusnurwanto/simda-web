<?php namespace Modules\Bendahara\Controllers\Spp\Tu;
/**
 * Bendahara > SPP > TU > Rinci
 *
 * @since			version 1.0.0
...
class Rinci extends \Aksara\Laboratory\Core
{
	...
	public function index()
	{
		...
		{
			if(service('request')->getPost('kegiatan') != 'all' && service('request')->getPost('kegiatan') != 'all')
			{
		...
		(
			array
			(
				'bendahara/spp/tu/sub_unit'			=> 'Bendahara Pengeluaran SPP Tu',
				'../spp/tu'							=> 'Spp Tu'
			)
		);
		...
		->unset_field('tahun, kd_urusan, kd_bidang, kd_unit, kd_sub, id_prog, kd_prog, kd_rek_1, kd_rek_2, kd_rek_3, kd_rek_4, kd_rek_5, no_spp, nilai, kd_sumber')
	...
	private function _dropdown()
	{
		...
		if('.belanja' == $element)
		{
			...
			(
				'ref_rek_5',
				'ref_rek_5.kd_rek_1 = ta_belanja_rinc_sub.kd_rek_1
				ref_rek_5.kd_rek_2 = ta_belanja_rinc_sub.kd_rek_2
				ref_rek_5.kd_rek_3 = ta_belanja_rinc_sub.kd_rek_3
				ref_rek_5.kd_rek_4 = ta_belanja_rinc_sub.kd_rek_4
				ref_rek_5.kd_rek_5 = ta_belanja_rinc_sub.kd_rek_5'
			)
			->order_by
			('
				kd_urusan,
