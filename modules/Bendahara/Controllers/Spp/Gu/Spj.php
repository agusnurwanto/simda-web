...
class Spj extends \Aksara\Laboratory\Core
{
	...
	public function index()
	{
		...
		->unset_view('tahun, no_id, no_spj_panjar, kd_urusan, kd_bidang, kd_unit, kd_sub, kd_prog, id_prog, kd_keg, kd_rek_1, kd_rek_2, kd_rek_3, kd_rek_4, kd_rek_5')
		->unset_truncate('keterangan')
		->view_order('no_pengesahan, tgl_pengesahan, keterangan, nilai_usulan, nilai_setuju, no_spd, no_spj')
		->set_field
		(
			'keterangan',
			'hyperlink',
		...
		(
			'ta_pengesahan_spj',
			'ta_pengesahan_spj.tahun = ta_pengesahan_spj_rinc.tahun AND
