...
class Rinci extends \Aksara\Laboratory\Core
{
	...
	public function index()
	{
		...
		$this->set_title('Rinc SPP Ganti Uang Persediaan')
		...
		->unset_column('tahun, kd_urusan, kd_bidang, kd_unit, kd_sub, id_prog, kd_rek_1, kd_rek_2, kd_rek_3, no_spp, nilai, kd_sumber, no_id, nm_sumber')
		->unset_field('tahun, kd_urusan, kd_bidang, kd_unit, kd_sub, id_prog, kd_prog, kd_keg, kd_rek_1, kd_rek_2, kd_rek_3, kd_rek_4, kd_rek_5, no_spp, nilai, kd_sumber')
	...
	public function kode_rekening_kd_rek1($params = array())
	{
		...
		else
		{
			...
			(
				'ta_spp_rinc',
				'ta_spp_rinc.kd_rek_1 = ta_belanja.kd_rek_1 AND ta_spp_rinc.kd_rek_2 = ta_belanja.kd_rek_2 AND ta_spp_rinc.kd_rek_3 = ta_belanja.kd_rek_3 AND ta_spp_rinc.kd_rek_4 = ta_belanja.kd_rek_4 AND ta_spp_rinc.kd_rek_5 = ta_belanja.kd_rek_5 AND ta_spp_rinc.kd_urusan = ta_belanja.kd_urusan AND ta_spp_rinc.kd_bidang = ta_belanja.kd_bidang AND ta_spp_rinc.kd_unit = ta_belanja.kd_unit AND ta_spp_rinc.kd_sub = ta_belanja.kd_sub AND ta_spp_rinc.kd_prog = ta_belanja.kd_prog AND ta_spp_rinc.kd_keg = ta_belanja.kd_keg'
			)
			*/
			->get_where
			(
