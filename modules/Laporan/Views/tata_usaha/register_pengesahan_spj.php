	...
	<body>
        ...
        <table class="table">
            ...
            foreach($results['data_query'] as $key => $val)
            {
	            ...
	            if($val->No_Pengesahan != $no_pengesahaan)
                {
                    echo '
                        <tr>
                            ...
                            <td class="border text-sm no-border-top no-border-bottom"> ';
                            if($val->Tgl_Pengesahan != $lewat_tanggal)
                            {
                                echo date_indo($val->Tgl_Pengesahan);
                            }
                            echo '
                            </td>
                            ...
                            <td class="border text-sm text-right no-border-top no-border-bottom">
                                ' . number_format_indo($val->Total, 2) . '
                            </td>
                            <td class="border text-sm no-border-top no-border-bottom">
                ...
                $no_pengesahaan                     = $val->No_Pengesahan;
	            $lewat_tanggal                      = $val->Tgl_Pengesahan;
	            $num++;
            }
            ?>
            </tbody>
        ...
        <table class="table" width="100%" style="page-break-inside:avoid">
            ...
            <tr>
                ...
                <td colspan="2" class="text-center border no-border-top no-border-left">
                    ...
                    <br />
                    <b><?php
						echo strtoupper($results['data_query'][0]->Jbt_PPK_SKPD);
						?></b>
                    <br />
                    <br />
                    <br />
                    ...
                    <br />
                    <u><b><?php
							echo $results['data_query'][0]->Nm_PPK_SKPD
							?></b></u>
                    <br />
					<?php
					echo 'NIP. '. $results['data_query'][0]->Nip_PPK_SKPD;
					?>
                </td>
            </tr>
            </tbody>
