	...
	<body>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <th class="border no-border-top text-sm-2" width="33%">
                    URAIAN
                </th>
            ...
            <tfoot>
            <tr>
                <td colspan="5" class="border text-sm text-right">
                    <b>TOTAL</b>
                </td>
        ...
        <table class="table" width="100%" style="page-break-inside:avoid">
            ...
            <tr>
                ...
                <td colspan="2" class="text-center border no-border-top no-border-left">
                    ...
                    <br />
                    <b><?php
						echo strtoupper($results['data_query'][0]->Jbt_Ka_BUD);
						?></b>
                    <br />
                    <br />
                    <br />
                    ...
                    <br />
                    <u><b><?php
							echo $results['data_query'][0]->Nm_Ka_BUD
							?></b></u>
                    <br />
					<?php
					echo 'NIP. '. $results['data_query'][0]->Nip_Ka_BUD;
					?>
                </td>
            </tr>
            </tbody>
