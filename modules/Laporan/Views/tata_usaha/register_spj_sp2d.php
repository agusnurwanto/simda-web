	...
	<body>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <th colspan="3" class="border no-border-top text-sm-2" width="26%">
                    SPJ
                </th>
                <th colspan="2" class="border no-border-top text-sm-2" width="23%">
                    SPP
                </th>
                <th colspan="2" class="border no-border-top text-sm-2" width="23%">
                    SPM
            ...
            foreach($results['data_query'] as $key => $val)
            {
	            ...
	            if($val->No_SPJ != $no_sp2d)
                {
                    echo '
                        <tr>
                            ...
                            <td class="border text-sm no-border-top no-border-bottom">';
                            if($val->Tgl_SPJ != $lewat_tanggal1)
                            {
                                echo date_indo($val->Tgl_SPJ);
                            }
                            echo '
                            </td>
                            <td class="border text-sm no-border-top no-border-bottom">
                            ...
                            <td class="border text-sm no-border-top no-border-bottom">';
                            if($val->Tgl_SP2D != $lewat_tanggal4)
                            {
                ...
                $no_sp2d                            = $val->No_SPJ;
	            $lewat_tanggal1                     = $val->Tgl_SPJ;
	            $lewat_tanggal2                     = $val->Tgl_SPP;
	            $lewat_tanggal3                     = $val->Tgl_SPM;
	            $lewat_tanggal4                     = $val->Tgl_SP2D;
	            $num++;
            }
            ?>
            </tbody>
            ...
            <tr>
                ...
                <td colspan="6" class="border text-sm text-right">
