	...
	<body>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <th class="border text-sm-2" width="45%">
                    URAIAN
                </th>
            ...
            <?php
                ...
                foreach($results['data_query'] as $key => $val)
                {
                    ...
                    if($val->Kd_Rek_Gab1 != $kd_rek_gab1)
                    {
                        echo '
                            <tr>
                    ...
                    if($val->Kd_Rek_Gab2 != $kd_rek_gab2)
                    {
                        echo '
                            <tr>
                                <td class="border text-sm no-border-top no-border-bottom">
                    ...
                    if($val->Kd_Rek_Gab3 != $kd_rek_gab3)
                    {
                        echo '
                            <tr>
                                <td class="border text-sm no-border-top no-border-bottom">
                    ...
                    $kd_rek_gab1                    = $val->Kd_Rek_Gab1;
                    $kd_rek_gab2                    = $val->Kd_Rek_Gab2;
                    $kd_rek_gab3                    = $val->Kd_Rek_Gab3;
                }
            ?>
            </tbody>
            <tfoot>
