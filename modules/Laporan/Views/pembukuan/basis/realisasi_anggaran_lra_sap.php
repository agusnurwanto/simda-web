			...
			<thead>
				<tr>
					...
					<th class="border no-border-left" align="center">
                        ...
                        <h6>
                            UNTUK TAHUN YANG BERAKHIR SAMPAI DENGAN 31 DESEMBER <?php echo get_userdata('year'); ?> DAN <?php echo date('Y', strtotime('-1 year', strtotime( get_userdata('year') ))); ?>
                        </h6>
					</th>
				</tr>
			</thead>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <th class="border text-sm-2" width="5%">
                    REALISASI
                    <br />
                    <?php echo date('Y', strtotime('-1 year', strtotime( get_userdata('year') ))); ?>
                </th>
            </tr>
            </thead>
            <tbody>
                    ...
                    echo '
                        <tr>
                            ...
                            if($val->Nm_Rek_1 == 'SURPLUS / (DEFISIT)' && $val->Kd_Rek_2 == '99' || $val->Nm_Rek_1 == 'SISA LEBIH PEMBIAYAAN ANGGARAN (SILPA)' && $val->Kd_Rek_2 == '4') {
                                ...
                                <td class="border text-sm text-right">
                                    ' . number_format_indo(str_replace('-', '', 0), 2) . '
                                </td>
                                <td class="border text-sm text-right">
                                    ' . number_format_indo(str_replace('-', '', $val->RealisasiX0), 2) . '
                                </td>
                            ';
                            }
                            else
