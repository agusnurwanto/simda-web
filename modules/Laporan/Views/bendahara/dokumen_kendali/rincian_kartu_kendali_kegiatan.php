	...
	<body>
			...
			<thead>
				<tr>
					...
					<th class="border no-border-left" align="center">
						...
						<h3>
							RINCIAN KARTU KENDALI KEGIATAN
						</h3>
						<h6>
                ...
                <td colspan="3" class="border no-border-top">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="text-sm-2 text-right no-padding">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <th colspan="2" class="border no-border-top text-sm-2" width="15%">
                    REALISASI KEGIATAN
                    <br />
                    (SP2D)
                </th>
            ...
            <tfoot>
            <tr>
                <td colspan="4" class="border text-sm-2 text-right">
                    <b>
                        JUMLAH
                    </b>
                </td>
