...
<html>
	...
	<body>
                ...
                <td colspan="3" class="border no-border-top">
                    <table>
                        <tr>
                            ...
                            <td width="23%" class="text-sm-2 no-padding">
								<?php echo $results['data_query'][0]->Kd_Bidang_Gab; ?>
                            </td>
                            <td width="55%" class="text-sm-2 no-padding">
        ...
        <table class="table">
            ...
            {
	            $pemotongan						    = (($val->Debet) ? $val->Debet : null);
	            $penyetoran						    = (($val->Kredit) ? $val->Kredit : null);
	            $saldo          				    = (($val->Saldo) ? $val->Saldo : null);
	            $total_pemotongan				    += $pemotongan;
	            $total_penyetoran				    += $penyetoran;
	            $total_saldo				        += $saldo;
	            echo '
                        <tr>
                            ...
                            <td class="border small text-center no-border-top no-border-bottom">
								...
								<td class="border text-right no-border-top no-border-bottom">
                                    ' . number_format_indo(str_replace("-", " ", $val->Saldo), 2) . '
								</td>
                        </tr>
                    ';
            ...
            <tr>
                ...
                <td class="border text-sm text-right">
                    <b>
	                    <?php echo number_format_indo($total_penyetoran, 2); ?>
                    </b>
                </td>
                <td class="border text-sm text-right">
                    <b>
	                    <?php echo number_format_indo($total_pemotongan, 2); ?>
                    </b>
                </td>
                <td class="border text-sm text-right">
                    <b>
