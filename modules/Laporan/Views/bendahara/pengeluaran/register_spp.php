...
<html>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th class="border no-border-left" align="center">
                ...
                <h6>
		            Periode : <?php echo get_userdata('year'); ?>
                    <br />
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th class="border text-sm-2" width="36%">
                URAIAN
            </th>
        ...
        <tr>
	        ...
	        {
		        $nilai						        = (($val->Nilai_SPP) ? $val->Nilai_SPP : null);
		        $jumlah_nilai				        += $nilai;
		        if($val->No_SPP != $no_spp)
		        {
			        echo '
                        <tr>
                            <td class="border text-sm text-center no-border-top no-border-bottom">
                                ' . date_indo($val->Tgl_SPP) . '
                            </td>
        ...
        <tfoot>
        <tr>
            <td colspan="4" class="border text-right text-sm-2">
                <b>JUMLAH</b>
            </td>
