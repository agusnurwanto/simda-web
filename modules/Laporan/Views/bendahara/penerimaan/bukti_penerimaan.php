...
<html>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th class="border no-border-left" align="center">
                ...
                <h6>
		            NOMOR BUKTI <?php echo (isset($results['data_query'][0]->No_Bukti) ? strtoupper($results['data_query'][0]->No_Bukti) : '-'); ?>
                </h6>
            </th>
        </tr>
        </thead>
            ...
            <td colspan="3" class="border no-border-top">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="text-sm-2 no-padding">
	                        <?php echo $results['data_query'][0]->Nama; ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-sm-2 no-padding">
                        ...
                        <td class="text-sm-2 no-padding">
	                        <?php echo $results['data_query'][0]->Alamat; ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-sm-2 no-padding">
    ...
    <table class="table">
        ...
        <tr>
            <td colspan="4" class="border no-border-bottom text-sm-2">
                Tanggal diterima uang : <?php echo date_indo($results['data_query'][0]->Tgl_Bukti) ?>
            </td>
        </tr>
        </tfoot>
    </table>
