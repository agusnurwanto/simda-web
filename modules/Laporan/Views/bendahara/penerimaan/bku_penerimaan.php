...
<html>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th class="border text-sm-2" width="23%">
                URAIAN
            </th>
        ...
        <tr>
            ...
            <td colspan="3" class="border no-border-bottom text-sm-2 text-right no-border-left no-border-right">
	            <?php echo number_format_indo($jumlah_debet, 2) ?>
            </td>
            <td class="border no-border-bottom text-sm-2 text-right no-border-left">
	            <?php echo number_format_indo($jumlah_kredit, 2) ?>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3" class="border no-border-top no-border-bottom text-sm-2 text-right no-border-left no-border-right">
		        <?php echo number_format_indo(0, 2) ?>
            </td>
            <td class="border no-border-top no-border-bottom text-sm-2 text-right no-border-left">
		        <?php echo number_format_indo(0, 2) ?>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="5" class="border no-border-top no-border-bottom text-sm-2 no-border-right">
                Sisa Kas
            </td>
            <td class="border no-border-bottom text-sm-2 text-right no-border-left no-border-right">
        ...
        <tr>
            <td colspan="7" class="border no-border-top no-border-bottom text-sm-2">
                Pada hari ini tanggal <b><?php echo date_indo(get_userdata('year').'-12-31'); ?></b>
            </td>
        </tr>
        <tr>
            <td colspan="7" class="border no-border-top no-border-bottom text-sm-2">
                oleh kami didapat dalam kas <b>Rp. <?php echo number_format_indo($results['data_query'][0]->Saldo, 2); ?></b>
            </td>
        </tr>
        <tr>
            <td colspan="7" class="border no-border-top no-border-bottom text-sm-2">
                <i><?php echo terbilang($results['data_query'][0]->Saldo); ?> rupiah</i>
            </td>
        </tr>
        </tfoot>
    </table>
