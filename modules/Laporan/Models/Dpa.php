 ...
 */
class Dpa extends \Aksara\Laboratory\Model
{
	 ...
	 * Query DPA
	 */
	public function dpa_skpd($params = null)
	{
...
/*		$tanggal_query								= $this->query
	...
	public function dpa_pendapatan_skpd($params = null)
	{
		if($params['kd_sub'] == 'all' || $params['kd_sub'] == NULL)
		{
			$sub_unit								= "'%'";
...
/*		$tanggal_query								= $this->query
	...
	public function dpa_belanja_skpd($params = null)
	{
		if($params['kd_sub'] == 'all' || $params['kd_sub'] == NULL)
		{
			$sub_unit								= "'%'";
		...
		('
			SELECT
				...
				ref_program.kd_prog AS kd_program,
				ta_kegiatan.kd_keg,

				ref_urusan.nm_urusan,
				ref_bidang.nm_bidang,
				ref_program.ket_program AS nm_program,
...
/*		$tanggal_query								= $this->query
	...
	public function dpa_rincian_belanja($params = null)
	{
		//print_r($params);exit;
		$header_query								= $this->query
		('
	...
	public function dpa_sub_kegiatan($params = null)
	{
		$header_query								= $this->query
		('
			SELECT
	...
	public function dpa_pembiayaan_skpd($params = null)
	{
		$header_query								= $this->query
		('
			SELECT
