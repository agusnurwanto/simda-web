...
/**
 * Laporan > Anggaran > RKA
 *
 * @since			version 1.0.0
 * @author			GeekTech Karya Indonesia, Ltd.
 * @website			www.geektech.id
 */
class Rka extends \Aksara\Laboratory\Core
{
	private $_title;
	private $_pageSize;
	private $_output;
	...
	public function __construct()
	{
		...
		$this->report								= new \Modules\Laporan\Models\Rka();
	...
	{
		$this->set_title('Laporan Anggaran RKA')
	...
	public function rka_pendapatan_skpd()
	{
		...
		$this->_title								= 'RKA PENDAPATAN SKPD';
		$this->_pageSize							= (3 == service('request')->getGet('kd_perubahan') ? '13in 8.5in' : null);
		$this->_output								= $this->report->rka_pendapatan_skpd($params);
	...
	public function rka_belanja_skpd()
	{
		...
		$this->_title								= 'RKA BELANJA SKPD';
		$this->_pageSize							= (3 == service('request')->getGet('kd_perubahan') ? '13in 8.5in' : null);
		$this->_output								= $this->report->rka_belanja_skpd($params);
	...
	public function rka_rincian_belanja()
	{
		...
		$this->_title								= 'RKA RINCIAN BELANJA SKPD';
		$this->_pageSize							= (3 == service('request')->getGet('kd_perubahan') ? '13in 8.5in' : null);
		$this->_output								= $this->report->rka_rincian_belanja($params);
	...
	public function rka_sub_kegiatan()
	{
		...
		$this->_title								= 'RKA SUB KEGIATAN SKPD';
		$this->_pageSize							= (3 == service('request')->getGet('kd_perubahan') ? '13in 8.5in' : null);
		$this->_output								= $this->report->rka_sub_kegiatan($params);
	...
	public function rka_pembiayaan_skpd()
	{
		...
		$this->_title								= 'RKA PEMBIAYAAN SKPD';
		$this->_pageSize							= (3 == service('request')->getGet('kd_perubahan') ? '13in 8.5in' : null);
		$this->_output								= $this->report->rka_pembiayaan_skpd($params);
	...
	public function rekening()
	{
		if(!($this->kd_rek_1))
		{
			return throw_exception(301, 'Silakan memilih Kode Rekening terlebih dahulu...', current_page('../'));
		}
	...
	public function sumber_dana()
	{
		...
		$this->_title								= 'SUMBER DANA';
		$this->_pageSize							= (3 == service('request')->getGet('kd_perubahan') ? '13in 8.5in' : null);
		$this->_output								= $this->report->sumber_dana($params);
	...
	private function _laporan()
	{
		...
		(
			...
			(
				...
				'description'						=> 'Rencana Kerja Anggaran SKPD',
				'icon'								=> 'mdi-chart-arc',
				'color'								=> 'bg-primary',
				'placement'							=> 'left',
				'controller'						=> 'rka_skpd',
			...
			(
				...
				'description'						=> 'Rencana Kerja Anggaran Pendapatan SKPD',
			...
			(
				...
				'description'						=> 'Rencana Kerja Anggaran Belanja SKPD',
			...
			(
				...
				'description'						=> 'Rencana Kerja Anggaran Rincian Belanja',
				'icon'								=> 'mdi-chart-bar',
				'color'								=> 'bg-maroon',
				'placement'							=> 'left',
			...
			(
				...
				'description'						=> 'Rencana Kerja Anggaran Sub Kegiatan',
			...
			(
				...
				'description'						=> 'Rencana Kerja Anggaran Pembiayaan',
	...
	private function _rek_1()
	{
		...
		$output										= null;
		$query										= $this->model
													->select('ref_rek_1.kd_rek_1, ref_rek_1.nm_rek_1')
													->order_by('ref_rek_1.kd_rek_1', 'ASC')
													->get_where('ref_rek_1', array('ref_rek_1.kd_rek_1' => 4))
													->result_array();
		if($query)
		{
			foreach($query as $key => $val)
			{
				$output								.= '<option value="' . $val['kd_rek_1'] . '">' . $val['kd_rek_1'] . '. ' . $val['nm_rek_1'] . '</option>';
			}
		}
		$output										= '
