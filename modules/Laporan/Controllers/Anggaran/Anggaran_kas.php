...
/**
 * Laporan > Anggaran > Anggaran Kas
 *
 * @since			version 1.0.0
 * @author			GeekTech Karya Indonesia, Ltd.
 * @website			www.geektech.id
 */
class Anggaran_kas extends \Aksara\Laboratory\Core
{
	private $_title;
	private $_pageSize;
	private $_output;
	...
	public function __construct()
	{
		...
		$this->report								= new \Modules\Laporan\Models\Anggaran_kas();
	...
	{
		$this->set_title('Laporan Anggaran Kas')
	...
	public function anggaran_kas()
	{
		...
		$this->_output								= $this->report->anggaran_kas($params);
	...
	public function rekapitulasi_anggaran_kas_kegiatan()
	{
		...
		$this->_pageSize							= (3 == service('request')->getGet('kd_perubahan') ? '13in 8.5in' : null);
		$this->_output								= $this->report->rekapitulasi_anggaran_kas_kegiatan($params);
	...
	public function rekapitulasi_anggaran_kas_per_bulan()
	{
		...
		$this->_title								= 'Rekapitulasi Anggaran Kas Per Bulan';
		$this->_pageSize							= (3 == service('request')->getGet('kd_perubahan') ? '13in 8.5in' : null);
		$this->_output								= $this->report->rekapitulasi_anggaran_kas_per_bulan($params);
	...
	private function _laporan()
	{
		...
		(
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Rekapitulasi Anggaran Kas Sub Unit per Bulan',
				'description'						=> 'Rekapitulasi Per Sub Unit per Bulan',
