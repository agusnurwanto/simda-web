 ...
 */
class Pertimbangan extends \Aksara\Laboratory\Core
{
	...
	public function __construct()
	{
		...
		{
			return throw_exception(301, 'Silakan memilih sub unit terlebih dahulu...', base_url('pertimbangan/sub_unit'));
		}
	}
	
	public function index()
	{
		$this->set_title('Pertimbangan')
		...
		->set_field('uraian', 'hyperlink', 'pertimbangan/kegiatan', array('id_pengajuan' => 'id'))
		->set_validation
		(
			array
			(
