 ...
 */
class Rekomendasi extends \Aksara\Laboratory\Core
{
	...
	public function __construct()
	{
		...
		{
			return throw_exception(301, 'Silakan memilih sub unit terlebih dahulu...', base_url('rekomendasi/sub_unit'));
		}
	}
	
	public function index()
	{
		$this->set_title('Rekomendasi')
		...
		->set_field('uraian', 'hyperlink', 'rekomendasi/kegiatan', array('id_pengajuan' => 'id'))
		->set_validation
		(
			array
			(
